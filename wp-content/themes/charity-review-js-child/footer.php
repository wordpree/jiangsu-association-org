        ...
        <div class="copyright clearfix">
		    ...
		    <div class="container pad0">
			  	...
			  	<div class="copyright-content">
			        <p class="text-right">
			        	<?php $copyright_link = esc_url( __( 'https://yijiang.com.au/','charity-review' ) ); ?>
			        		<?php esc_html_e('Charity Review Child Theme Developed by ', 'charity-review');?>
	        				<a href="<?php echo $copyright_link; ?>" target="_blank">
	        					 <?php printf( esc_html__( 'Hai','charity-review' ), 'Hai' ); ?>
	        				</a>
					</p>
			  	</div>
